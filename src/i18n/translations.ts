...
export const translations = {
  he: {
    ...
    dashboard: {
      ...
      categoryEditHint: 'עריכת קטגוריות אפשרית גם דרך לשונית ״הגדרות״.',
      addFormRequiredNote: 'ניתן לערוך את פרטי המוצר בכל עת.',
      ...
      seoHeading: 'טיפים לנראות במנועי חיפוש (SEO)',
      seoMissingLabel: 'חסר',
