...
export const translations = {
  he: {
    ...
    dashboard: {
      ...
      offerKeep: 'אם תשאיר את המוצר אצלך',
      offerAccept: 'מקבל את ההצעה',
      offerDecline: 'לא, אני מחזיר את המוצר',
      orderPhone: 'טלפון',
      orderAddress: 'כתובת',
  ...
  en: {
    ...
    dashboard: {
      ...
      offerKeep: 'if you keep the item',
      offerAccept: 'Accept',
      offerDecline: 'No, I will send it back',
      orderPhone: 'Phone',
