...
export const translations = {
  he: {
    ...
    dashboard: {
      ...
      paySubtitle: 'הכסף מההזמנות שלך מוחזק אצלנו זמן קצר, ואז עובר לחשבון הבנק שלך ב-{day} לכל חודש.',
      payAllStores: 'כולל את כל החנויות שלך',
      payPayableNow: 'מוכן להעברה אליך',
      payPayableNowHint: 'זה הסכום שיעבור לחשבון שלך בתשלום הקרוב.',
      payHeld: 'עדיין מוחזק',
      payHeldHint: 'כסף מהזמנות שהקונה עוד יכול להחזיר. משתחרר אליך לבד, בלי שתעשו כלום.',
      payPaidOut: 'כבר הועבר אליך',
      payPaidOutHint: 'סך כל ההעברות שיצאו אליך מאז שפתחתם חנות.',
      ...
      payBankHint: 'בלי אלה אי אפשר להעביר כסף. היתרה ממשיכה להיצבר עד שתמלאו.',
      payBankCode: 'קוד בנק',
      payBankBranch: 'סניף',
      ...
      payHeldTitle: 'מה עוד מוחזק, ועד מתי',
      payHeldEmpty: 'אין כרגע כסף בהמתנה.',
      payPagePrev: 'הקודם',
      payPageNext: 'הבא',
      ...
      payColStore: 'חנות',
      payColAmount: 'סכום',
      payColRelease: 'עובר אליך ב',
      payColWhy: 'למה עד אז',
      payWhyDelivery: '{n} ימים מהיום שהקונה קיבל את החבילה — זה החלון שבו מותר לו להחזיר',
      payWhyPayment: 'לא סומן שנמסר, ולכן סופרים {n} ימים מיום שהקונה שילם',
      payWhyUnshipped: 'עוד לא נשלח. הספירה מתחילה ברגע שתסמנו את ההזמנה כנשלחה',
      payWhyUnknown: 'ממתין לבדיקה שלנו',
  ...
  en: {
    ...
    dashboard: {
      ...
      paySubtitle: 'Money from your orders is held with us for a short while, then moves to your bank account on the {day} of each month.',
      payAllStores: 'Covers all of your stores',
      payPayableNow: 'Ready to send you',
      payPayableNowHint: 'This is what moves to your account in the next payment.',
      payHeld: 'Still held',
      payHeldHint: 'Money from orders the buyer can still return. It releases to you on its own.',
      payPaidOut: 'Already sent to you',
      payPaidOutHint: 'Every transfer that has gone out to you since you opened.',
      ...
      payBankHint: 'Without these no transfer can be made. The balance keeps accruing until you fill them in.',
      ...
      payHeldTitle: 'What is still held, and until when',
      payHeldEmpty: 'Nothing on hold right now.',
      ...
      payColStore: 'Store',
      payColAmount: 'Amount',
      payColRelease: 'Reaches you on',
      payColWhy: 'Why then',
      payWhyDelivery: '{n} days from the day the buyer received the parcel — their return window',
      payWhyPayment: 'Not marked delivered, so we count {n} days from the day the buyer paid',
      payWhyUnshipped: 'Not shipped yet. The countdown starts the moment you mark it shipped',
      payWhyUnknown: 'Being checked by us',
