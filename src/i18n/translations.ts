...
export const translations = {
  he: {
    ...
    dashboard: {
      ...
      mkCategoryHint: 'נקבע לפי הקטגוריות של החנות. אם החנות מוכרת מכל תחום, צריך לבחור אחד.',
      mkCity: 'עיר',
      mkStreet: 'רחוב',
      mkStreetNumber: 'מספר',
      ...
      subCancel: 'בטל מנוי',
      subCancelConfirmTitle: 'לבטל את המנוי?',
      subCancelConfirmBody: 'החיוב החודשי ייפסק. החנות נשארת באוויר וההזמנות הפתוחות ממשיכות כרגיל.',
      subCanceled: 'המנוי בוטל.',
  ...
  en: {
    ...
    dashboard: {
      ...
      mkCategoryHint: "Taken from the store's categories. Pick one if the store sells across fields.",
      mkCity: 'City',
      mkStreet: 'Street',
      ...
      subCancelConfirmTitle: 'Cancel the subscription?',
      subCancelConfirmBody: 'The monthly charge stops. The store stays live and open orders continue as normal.',
      subCanceled: 'The subscription was cancelled.',
