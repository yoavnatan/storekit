...
export const translations = {
  he: {
    ...
    dashboard: {
      ...
      ownClearingLead: 'הכסף מהקונים נכנס ישירות לחשבון הסליקה שלכם. בחרו את חברת הסליקה שאתם עובדים איתה והדביקו את הפרטים שהיא נתנה לכם.',
      ownClearingPick: 'חברת הסליקה',
      ownClearingComing: 'עוד לא זמין',
      ownClearingComingWhy: 'חברות הסליקה המסומנות ״עוד לא זמין״ עדיין לא נתמכות.',
  ...
  en: {
    ...
    dashboard: {
      ...
      ownClearingLead: 'Buyers pay straight into your own clearing account. Pick the processor you work with and paste what they gave you.',
      ownClearingPick: 'Processor',
      ownClearingComing: 'Not available yet',
      ownClearingComingWhy: 'The processors marked “not available yet” are not supported yet.',
      ...
      ownClearingMissing: '{n} more fields are needed before your store can take payment',
      ownClearingMissingOne: 'One more field is needed before your store can take payment',
