...
export const translations = {
  he: {
    ...
    dashboard: {
      ...
      glStateLive: 'החנות מוכנה לעלות — נשאר רק להפעיל את המנוי.',
      ...
      glStepSubscription: 'מסלול ותשלום',
      glStepSubscriptionNote: 'זה מה שמעלה את החנות לאוויר. אפשר לבטל בכל רגע.',
  ...
  en: {
    ...
    dashboard: {
      ...
      glStateLive: 'This store is ready to go live — all that is left is to start the subscription.',
      ...
      glStepSubscription: 'Plan and payment',
      glStepSubscriptionNote: 'This is what puts the store live. Cancel any time.',
