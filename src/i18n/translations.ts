...
export const translations = {
  he: {
    ...
    dashboard: {
      ...
      payHeldTitle: 'הזמנות שממתינות לאישור סופי',
      payHeldEmpty: 'אין הזמנות שממתינות לאישור.',
      payPagePrev: 'הקודם',
      payPageNext: 'הבא',
  ...
  en: {
    ...
    dashboard: {
      ...
      payHeldTitle: 'Orders awaiting final approval',
      payHeldEmpty: 'No orders are awaiting approval.',
      ...
      payColStore: 'Store',
      payColAmount: 'Amount',
      payColRelease: 'Final approval date',
      payColWhy: 'Reason',
      payColAction: 'Action needed',
      payWhyDelivery: 'The buyer\'s return window — {n} days from delivery',
      payActionNone: 'None. It reaches you on its own',
      payWhyPayment: 'Not marked delivered — {n} days from the payment date',
      payActionMarkDelivered: 'Mark it delivered when the parcel arrives',
      payWhyUnshipped: 'This order has not been shipped',
      payActionShip: 'Ship the order — nothing counts until you do',
