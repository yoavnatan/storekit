...
export const translations = {
  he: {
    ...
    dashboard: {
      ...
      paySubtitle: 'מה מגיע לך, מתי הוא משתחרר, ולאן הוא נשלח.',
      payAllStores: 'כולל את כל החנויות שלך',
      payPayableNow: 'לתשלום עכשיו',
      payHeld: 'בהמתנה',
      payPaidOut: 'שולם עד היום',
      payCarried: 'חוב שגולגל',
      payCarriedHint: 'סכום שקוזז ולא היה ממה לנכות אותו. יופחת מהתשלום הבא.',
      payNextRun: 'התשלומים יוצאים ב-{day} לכל חודש.',
      ...
      payHeldTitle: 'ממתין לשחרור',
      payHeldEmpty: 'אין כרגע כסף בהמתנה.',
      payHeldMore: 'ועוד {n} הזמנות בהמתנה. הסכומים למעלה כוללים את כולן.',
      payColOrder: 'הזמנה',
      payColStore: 'חנות',
      payColAmount: 'סכום',
      payColRelease: 'משתחרר',
      payColWhy: 'למה',
      payWhyDelivery: 'נספר מיום המסירה',
      payWhyPayment: 'נספר מיום התשלום',
      payWhyUnshipped: 'עוד לא נשלח — השעון מתחיל כששולחים',
      payWhyUnknown: 'ממתין לבדיקה',
  ...
  en: {
    ...
    dashboard: {
      ...
      paySubtitle: 'What you are owed, when it clears, and where it goes.',
      payAllStores: 'Covers all of your stores',
      payPayableNow: 'Payable now',
      payHeld: 'On hold',
      payPaidOut: 'Paid to date',
      payCarried: 'Carried debt',
      payCarriedHint: 'An offset larger than the balance it came out of. It comes off your next payment.',
      payNextRun: 'Payments go out on the {day} of each month.',
      ...
      payHeldTitle: 'Waiting to clear',
      payHeldEmpty: 'Nothing on hold right now.',
      payHeldMore: 'And {n} more on hold. The totals above include all of them.',
      payColOrder: 'Order',
      payColStore: 'Store',
      payColAmount: 'Amount',
      payColRelease: 'Clears',
      payColWhy: 'Why',
      payWhyDelivery: 'Counted from delivery',
      payWhyPayment: 'Counted from payment',
      payWhyUnshipped: 'Not shipped yet — the clock starts when you ship',
      payWhyUnknown: 'Being checked',
