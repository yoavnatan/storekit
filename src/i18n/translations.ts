...
export const translations = {
  he: {
    ...
    dashboard: {
      ...
      variantLimitDims: 'מעל {max} סוגי גרסה — המלאי של המוצר הזה ייערך רק כאן, בדשבורד. לא בקובץ ולא בסנכרון חיצוני.',
      variantLimitCombos: '{n} שילובים — המקסימום {max}. הסירו ערכים.',
  ...
  en: {
    ...
    dashboard: {
      ...
      variantLimitDims: 'More than {max} variant types — this product\'s stock is edited here, in the dashboard, only. Not in a file and not by an external sync.',
      variantLimitCombos: '{n} combinations — the maximum is {max}. Remove some values.',
