...
export const translations = {
  he: {
    ...
    dashboard: {
      ...
      ownClearingComingWhy: 'אין לחברה תיעוד פתוח למפתחים, ואנחנו לא מנחשים שדות. ברגע שנקבל ממנה את המסמך זה ייפתח.',
  ...
  en: {
    ...
    dashboard: {
      ...
      ownClearingComingWhy: 'This processor publishes no developer documentation, and we do not guess field names. It opens the day they send us the document.',
