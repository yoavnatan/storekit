...
export const translations = {
  he: {
    ...
    dashboard: {
      ...
      variantLimitDims: 'מעל {max} סוגי גרסה — את המלאי של המוצר הזה אפשר יהיה לערוך רק כאן. קובץ וסנכרון מלאי חיצוני לא יעדכנו אותו.',
      variantLimitCombos: '{n} צירופים, והמקסימום הוא {max}. הסירו ערכים או סוגי גרסה כדי לשמור.',
  ...
  en: {
    ...
    dashboard: {
      ...
      variantLimitDims: 'More than {max} variant types — this product\'s stock will then be editable here only. A file or an external inventory sync cannot update it.',
      variantLimitCombos: '{n} combinations, and the maximum is {max}. Remove values or variant types to save.',
