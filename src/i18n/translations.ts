...
export const translations = {
  he: {
    ...
    dashboard: {
      ...
      variantLimitCombos: 'יותר מדי שילובים — אי אפשר לשמור. הסירו ערכים או סוגי גרסה.',
  ...
  en: {
    ...
    dashboard: {
      ...
      variantLimitCombos: 'Too many combinations — this cannot be saved. Remove values or variant types.',
