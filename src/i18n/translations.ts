...
export const translations = {
  he: {
    ...
    dashboard: {
      ...
      cancelAfterShip: 'החבילה כבר בדרך אליך ואי אפשר לעצור אותה. ברגע שתגיע ניתן יהיה לבקש להחזיר אותה מכאן.',
  ...
  en: {
    ...
    dashboard: {
      ...
      cancelAfterShip: 'The parcel is already on its way and cannot be stopped. Once it arrives you can ask to return it from here.',
