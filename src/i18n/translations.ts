...
export const translations = {
  he: {
    ...
    dashboard: {
      ...
      subTitle: 'מנוי חודשי',
      subWhy: 'החנות עולה לאוויר כשהמנוי מתחיל, וניתן לבטל בכל שלב.',
      subPlan: 'המסלול שלך',
      ...
      // ── The seller's OWN clearing account (SaaS shape, docs/pivot-saas.md) ──
      // He keeps his account at his own provider, the buyer's money goes straight into it, and we
      // never hold a shekel of it. So this block asks him to PASTE what that provider gave him —
      // it is not a form we send anywhere. `ownClearing*`, and every string here is written to a
      // person looking at another browser tab: it has to name what HIS provider calls the value,
      // not what we call it (`clearing-providers.ts` carries the same rule for the field labels).
      ownClearingTitle: 'חשבון הסליקה שלכם',
      ownClearingLead: 'בחרו את חברת הסליקה שאתם עובדים איתה והדביקו את הפרטים שהיא נתנה לכם.',
      ownClearingPick: 'חברת הסליקה',
      // ── "החשבון שלי", הגדרות ──
      accountTitle: 'החשבון שלי',
      accountLead: 'הפרטים שלכם כבעלי החשבון, בנפרד מפרטי החנות.',
      accountName: 'שם מלא',
      accountEmail: 'אימייל לכניסה',
      accountPhone: 'טלפון',
      accountPhoneWhy: 'נדרש לחיוב דמי המנוי.',
      accountSave: 'שמירת הפרטים',
      accountSaved: 'הפרטים נשמרו',
      accountFailed: 'לא הצלחנו לשמור את הפרטים. נסו שוב.',
      ownClearingNone: 'עדיין לא נבחרה חברת סליקה',
      ownClearingPickFirst: 'יש לבחור חברת סליקה',
      // The same words `formErrors.required` uses — one wording for one situation, site-wide.
      fieldRequired: 'יש למלא שדה זה',
      ownClearingChosen: 'נבחרה {name}',
      ownClearingClear: 'ביטול הבחירה',
      ownClearingDisconnect: 'ניתוק החברה',
      ownClearingClearAsk: 'לבטל את הבחירה ב{name}?',
      ownClearingDisconnectAsk: 'לנתק את {name}?',
      ownClearingDisconnectBody: 'הפרטים שהדבקתם יימחקו מאצלנו. תמיד ניתן להדביק אותם שוב מהממשק של חברת הסליקה.',
      ownClearingDisconnectOk: 'ניתוק',
      ownClearingDisconnected: 'החברה נותקה',
      ownClearingOnFile: 'מחוברים ל־{name}',
      ownClearingSecretOnFile: 'שמור',
      ownClearingSecretKeep: 'השאירו ריק כדי לא לשנות',
      ownClearingReady: 'החנויות שלכם יכולות לקבל תשלום.',
      ownClearingSave: 'שמירת פרטי הסליקה',
      ownClearingSaved: 'פרטי הסליקה נשמרו',
      ownClearingEdit: 'ערוך',
      ownClearingCancel: 'ביטול',
      ...
      addFormMore: 'פרטים נוספים — לא חובה',
  ...
  en: {
    ...
    dashboard: {
      ...
      subWhy: 'Your store goes live when the subscription starts, and you can cancel at any point.',
      subPlan: 'Your plan',
      subPlanValue: '{name} — ₪{fee} {per}',
      ...
      ownClearingTitle: 'Your clearing account',
      ownClearingLead: 'Pick the processor you work with and paste what they gave you.',
      ownClearingPick: 'Processor',
      accountTitle: 'My account',
      accountLead: 'Your details as the account holder, separately from the store\'s.',
      accountName: 'Full name',
      accountEmail: 'Sign-in email',
      accountPhone: 'Phone',
      accountPhoneWhy: 'Needed to charge the subscription.',
      accountSave: 'Save details',
      accountSaved: 'Details saved',
      accountFailed: 'We could not save the details. Try again.',
      ownClearingNone: 'No processor chosen yet',
      ownClearingPickFirst: 'Choose a processor first',
      fieldRequired: 'This field is required',
      ownClearingChosen: '{name} chosen',
      ownClearingClear: 'Clear the choice',
      ownClearingDisconnect: 'Disconnect',
      ownClearingClearAsk: 'Clear the choice of {name}?',
      ownClearingDisconnectAsk: 'Disconnect {name}?',
      ownClearingDisconnectBody: 'What you pasted is deleted from our side. You can always paste it again from your processor\'s own screen.',
      ownClearingDisconnectOk: 'Disconnect',
      ownClearingDisconnected: 'Disconnected',
      ownClearingOnFile: 'Connected to {name}',
      ownClearingSecretOnFile: 'saved',
      ownClearingSecretKeep: 'Leave blank to keep it unchanged',
      ownClearingReady: 'Your stores can take payment.',
      ownClearingSave: 'Save clearing details',
      ownClearingSaved: 'Clearing details saved',
      ownClearingEdit: 'Edit',
      ownClearingCancel: 'Cancel',
      ownClearingFailed: 'We could not save the details. Try again.',
