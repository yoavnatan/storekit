...
export const translations = {
  he: {
    ...
    dashboard: {
      ...
      cancelAfterShip: 'החבילה כבר בדרך אליך ואי אפשר לעצור אותה. ברגע שתגיע אפשר לבקש להחזיר אותה מכאן. אם המוצר תקין ופשוט נמלכת בדעתך — דמי המשלוח אינם מוחזרים והמשלוח בחזרה על חשבונך.',
  ...
  en: {
    ...
    dashboard: {
      ...
      cancelAfterShip: 'The parcel is already on its way and cannot be stopped. Once it arrives you can ask to return it from here. If the item is fine and you simply changed your mind, the delivery charge is not refunded and return postage is yours.',
