...
export type NotificationType = 'new_message' | 'seller_reply' | 'new_order' | 'order_update' | 'return_update' | 'low_stock' | 'out_of_stock' | 'admin_message' | 'domain_status' | 'feed_status' | 'payout_status' | 'store_live' | 'merchant_approved';
