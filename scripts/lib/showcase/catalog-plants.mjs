...
export const PLANT_PRODUCTS = [
  // ── צמחי פנים (c:0) ────────────────────────────────────────────────────────
  { n: 'מונסטרה דליציוזה', d: 'העלים המחורצים הגדולים שכולם מזהים. אור עקיף בהיר, השקיה כשהאדמה יבשה בחלק העליון.\n\nגדלה מהר ובגדול — בתוך שנתיים היא תופסת פינה שלמה, אז שווה לתת לה מקום מראש. עמוד תמיכה נכנס בקלות לעציץ כשהיא מתחילה להישען.', c: 0, sub: 'צמחי עלווה', sub2: 'עלים גדולים', p: 129, w: 2_400, v: 'potSize', s: 'a monstera deliciosa houseplant with large split leaves in a terracotta pot' },
  { n: 'פיקוס ליראטה', d: 'עלים גדולים בצורת כינור, צמח שמחזיק חדר לבד. אוהב אור בהיר וקבוע ולא אוהב שמזיזים אותו.', c: 0, sub: 'צמחי עלווה', sub2: 'עלים גדולים', p: 189, w: 3_200, v: 'potSize', s: 'a fiddle leaf fig plant with large violin-shaped leaves in a pale stoneware pot' },
  { n: 'פותוס זהוב', d: 'הצמח שהכי קשה להרוג. משתלשל יפה ממדף וסובל גם אור חלש.', c: 0, sub: 'צמחי עלווה', sub2: 'מטפסים ומשתלשלים', p: 59, w: 900, v: 'potSize', s: 'a golden pothos trailing plant with variegated heart-shaped leaves' },
  { n: 'סנסיווריה', d: 'עלים זקופים וקשיחים, שורדת שבועיים בלי מים בלי להתלונן.\n\nהבחירה הנכונה לחדר עם מעט אור או למי ששוכח להשקות. גם מסננת אוויר טוב מרוב הצמחים.', c: 0, sub: 'צמחי עלווה', sub2: 'עמידים לצל', p: 79, w: 1_600, v: 'potSize', s: 'a snake plant with tall upright variegated leaves in a concrete pot' },
  { n: 'זמיוקולקס', d: 'עלים מבריקים כמעט מלאכותיים למראה. מים פעם בשבועיים, אור בינוני, וזהו.', c: 0, sub: 'צמחי עלווה', sub2: 'עמידים לצל', p: 89, w: 1_800, v: 'potSize', s: 'a ZZ plant with glossy dark green leaves in a matte black pot' },
  { n: 'פילודנדרון לב', d: 'עלים בצורת לב שמשתלשלים במהירות. מושלם לתלייה או לראש ארון.', c: 0, sub: 'צמחי עלווה', sub2: 'מטפסים ומשתלשלים', p: 69, w: 800, v: 'potSize', s: 'a heartleaf philodendron trailing from a hanging pot' },
  { n: 'קלתיאה אורביפוליה', d: 'עלים עגולים עם פסים כסופים שנסגרים בלילה. אוהבת לחות — מקום טוב בשבילה הוא אמבטיה עם חלון.', c: 0, sub: 'צמחים טרופיים', p: 119, w: 1_400, v: 'potSize', s: 'a calathea orbifolia with round silver-striped leaves' },
  { n: 'אלוקסיה', d: 'עלים משולשים גדולים עם עורקים בולטים. דרמטית, ודורשת לחות ואור עקיף.', c: 0, sub: 'צמחים טרופיים', p: 149, w: 1_600, v: 'potSize', s: 'an alocasia plant with dramatic arrow-shaped veined leaves' },
  { n: 'מרנטה', d: 'דוגמת עלים צבעונית שמתקפלת בערב כמו כפות ידיים. צמח שכיף להסתכל עליו משתנה.', c: 0, sub: 'צמחים טרופיים', p: 89, w: 900, v: 'potSize', s: 'a maranta prayer plant with patterned red-veined leaves' },
  { n: 'שרך בוסטון', d: 'עלווה עשירה ומתפרצת. אוהב לחות גבוהה, אז ריסוס פעמיים בשבוע עושה לו טוב.', c: 0, sub: 'צמחים טרופיים', p: 79, w: 1_200, v: 'potSize', s: 'a lush boston fern in a hanging basket' },
  { n: 'פפרומיה', d: 'עלים עבים וקטנים, צמח קומפקטי שנשאר בגודל שלו. מתאים למדף צר או לשולחן עבודה.', c: 0, sub: 'צמחים טרופיים', p: 55, w: 600, v: 'potSize', s: 'a small peperomia plant with thick round leaves' },
  { n: 'דרצנה מרג׳ינטה', d: 'גזע דק ועלים צרים כמו זיקוקים. גדלה לגובה ולא לרוחב, נוחה לפינות.', c: 0, sub: 'צמחי עלווה', sub2: 'עמידים לצל', p: 99, w: 1_800, v: 'potSize', s: 'a dracaena marginata with a slim trunk and narrow spiky leaves' },
  { n: 'ספתיפילום', d: 'עלים כהים ופרח לבן שחוזר כמה פעמים בשנה. מסמנת לך שהיא צמאה בכך שהעלים נופלים — ומתאוששת תוך שעה.', c: 0, sub: 'צמחי עלווה', sub2: 'עמידים לצל', p: 79, w: 1_200, v: 'potSize', s: 'a peace lily with dark leaves and a single white spathe flower' },
  { n: 'אפיפרמנום מנומר', d: 'גרסה מנומרת בלבן־ירוק. ככל שהאור בהיר יותר, הנמר בולט יותר.', c: 0, sub: 'צמחי עלווה', sub2: 'מטפסים ומשתלשלים', p: 89, w: 800, v: 'potSize', s: 'a variegated marble queen pothos with white and green leaves' },
  { n: 'הויה', d: 'עלים עבותים ומבריקים, ובבגרות אשכולות פרחים שעווניים בריח מתוק. צמח סבלני מאוד.', c: 0, sub: 'צמחי עלווה', sub2: 'מטפסים ומשתלשלים', p: 109, w: 900, v: 'potSize', s: 'a hoya plant with thick waxy trailing leaves' },
  { n: 'קקטוס עמוד', d: 'קקטוס זקוף ואדריכלי. שמש מלאה, ומים אחת לשלושה שבועות בקיץ בלבד.', c: 0, sub: 'קקטוסים וסוקולנטים', p: 89, w: 2_200, v: 'potSize', s: 'a tall columnar cactus in a concrete pot' },
  { n: 'שלישיית סוקולנטים', d: 'שלושה זנים שונים בעציצים קטנים תואמים. מתנה קטנה שנשארת בחיים.', c: 0, sub: 'קקטוסים וסוקולנטים', p: 79, w: 900, v: null, s: 'three small succulents in matching miniature pots' },
  { n: 'אכוריה', d: 'ורדת עלים סימטרית וקומפקטית. אדמה מנקזת, שמש חלקית, ומעט מאוד מים.', c: 0, sub: 'קקטוסים וסוקולנטים', p: 45, w: 400, v: null, s: 'a small echeveria succulent rosette' },
  { n: 'אלוורה', d: 'צמח שימושי באמת — הג׳ל בעלה מרגיע כוויות שמש. שמש בהירה ומים נדירים.', c: 0, sub: 'קקטוסים וסוקולנטים', p: 65, w: 1_100, v: 'potSize', s: 'an aloe vera plant with thick pointed leaves' },
  { n: 'פילודנדרון ברזילאי', d: 'עלים מוארכים עם פס בהיר במרכז. גדל מהר ומשתלשל יפה.', c: 0, sub: 'צמחי עלווה', sub2: 'עלים גדולים', p: 79, w: 900, v: 'potSize', s: 'a philodendron brasil with striped yellow-green trailing leaves' },
  { n: 'בונסאי פיקוס', d: 'עץ מיניאטורי מעוצב בעבודת יד, מגיע בקערת קרמיקה שטוחה.\n\nדורש תשומת לב שבועית — השקיה קטנה וקבועה וגיזום קל פעמיים בשנה. זה לא צמח שמניחים ושוכחים, וזה בדיוק העניין בו.', c: 0, sub: 'צמחי עלווה', sub2: 'עלים גדולים', p: 249, w: 1_800, v: null, s: 'a small ficus bonsai tree in a shallow ceramic bowl' },
  { n: 'קיסוס אנגלי', d: 'משתלשל צפוף עם עלים קטנים. מצוין למדף גבוה או לסלסלה תלויה.', c: 0, sub: 'צמחי עלווה', sub2: 'מטפסים ומשתלשלים', p: 59, w: 700, v: 'potSize', s: 'an english ivy trailing plant in a hanging pot' },
  { n: 'צמח כסף סיני', d: 'עלים כסופים־ירוקים, סובל אור נמוך ומזגן. מהעמידים שיש.', c: 0, sub: 'צמחי עלווה', sub2: 'עמידים לצל', p: 89, w: 1_200, v: 'potSize', s: 'a chinese evergreen aglaonema with silver-green patterned leaves' },
  { n: 'פיקוס בנג׳מין', d: 'עץ פנים קלאסי עם עלווה צפופה. מפיל עלים כשמזיזים אותו — בחרו מקום ותשאירו אותו שם.', c: 0, sub: 'צמחי עלווה', sub2: 'עלים גדולים', p: 139, w: 2_600, v: 'potSize', s: 'a ficus benjamina indoor tree with dense small leaves' },
