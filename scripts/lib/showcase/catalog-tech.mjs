/**
 * וולט — the electronics showcase catalog (100 products).
 *
...
export const TECH_PRODUCTS = [
  // ── שמע (c:0) ──────────────────────────────────────────────────────────────
  { n: 'אוזניות קשת עם ביטול רעשים', d: 'ביטול רעשים אקטיבי, 40 שעות האזנה בטעינה מלאה וכריות זיכרון שלא לוחצות אחרי שעתיים.', c: 0, p: 899, w: 280, v: 'colorTech', s: 'over-ear wireless headphones with memory foam ear cushions' },
  { n: 'אוזניות קשת לאולפן', d: 'תגובת תדר שטוחה וכבל נשלף באורך 3 מטר. חיבור 3.5 מ״מ ומתאם ג׳ק גדול בקופסה.', c: 0, p: 649, w: 320, v: 'colorTech', s: 'wired studio monitor headphones with a coiled detachable cable' },
  { n: 'אוזניות אלחוטיות בתוך האוזן', d: 'שש שעות בכל אוזנייה ועוד עשרים בכיסוי, זיהוי אוזן שעוצר כשמוציאים.', c: 0, p: 449, w: 60, v: 'colorTech', s: 'true wireless earbuds beside their charging case' },
  { n: 'אוזניות ספורט עם וו אוזן', d: 'עמידות בזיעה ובגשם, וו גמיש שלא זז בריצה.', c: 0, p: 329, w: 70, v: 'colorTech', s: 'sport earbuds with flexible over-ear hooks' },
  { n: 'אוזניות הולכה עצמית', d: 'משאירות את האוזן פתוחה כדי לשמוע תנועה. לרכיבה ולריצה בעיר.', c: 0, p: 599, w: 110, v: 'colorTech', s: 'open-ear bone conduction headphones' },
  { n: 'רמקול בלוטות׳ נייד', d: 'עמידות IPX7 מלאה למים, 20 שעות ניגון ורצועה לתלייה.', c: 0, p: 399, w: 640, v: 'colorTech', s: 'a portable cylindrical bluetooth speaker with a fabric grille and a wrist strap' },
  { n: 'רמקול בלוטות׳ קטן', d: 'נכנס לכיס ומחזיק יום שלם. מתאים למרפסת ולנסיעות.', c: 0, p: 199, w: 260, v: 'colorTech', s: 'a compact pocket bluetooth speaker' },
  { n: 'רמקול מדף לסלון', d: 'זוג רמקולים פסיביים עם דופן עץ, מתחברים למגבר קיים.', c: 0, p: 1_290, w: 6_800, v: 'colorTech', s: 'a pair of bookshelf speakers with wooden cabinets and fabric fronts' },
  { n: 'סאונדבר לטלוויזיה', d: 'שיפור ניכר על רמקולי הטלוויזיה בחיבור אחד, עם סאב אלחוטי נפרד.', c: 0, p: 1_190, w: 4_200, v: null, s: 'a slim soundbar with a separate wireless subwoofer' },
  { n: 'מגבר סטריאו קומפקטי', d: 'שני ערוצים בהספק אמיתי, כניסת בלוטות׳ וכניסת פטיפון מובנית.', c: 0, p: 1_490, w: 5_400, v: null, s: 'a compact stereo amplifier with a large volume knob and a brushed front panel' },
  { n: 'פטיפון עם מגבר מובנה', d: 'מחט מתחלפת ומגבר פנימי, מתחבר ישירות לרמקולים פעילים.', c: 0, p: 1_690, w: 5_600, v: null, s: 'a modern turntable with a built-in preamp on a wooden plinth' },
  { n: 'מיקרופון USB לשולחן', d: 'תבנית קרדיואידית שקולטת אותך ולא את החדר, כולל יציאת אוזניות לניטור.', c: 0, p: 549, w: 780, v: 'colorTech', s: 'a USB condenser desktop microphone on a small stand' },
  { n: 'מיקרופון דש אלחוטי', d: 'שני משדרים ומקלט אחד, לצילום ראיון בשני אנשים.', c: 0, p: 749, w: 220, v: null, s: 'a wireless lavalier microphone kit with two transmitters and a receiver' },
  { n: 'זרוע מיקרופון', d: 'זרוע מפרקית עם מהדק שולחן ומעבר כבלים פנימי.', c: 0, p: 269, w: 1_100, v: 'colorTech', s: 'an articulated microphone boom arm with a desk clamp' },
  { n: 'ממיר USB לאודיו', d: 'ממיר חיצוני שמשפר משמעותית אוזניות טובות מול כרטיס קול מובנה.', c: 0, p: 429, w: 90, v: null, s: 'a small external USB digital-to-analog audio converter' },
  { n: 'רמקול רטרו עם ידית', d: 'גוף מתכת וידית עור, בלוטות׳ מלא בפנים. נראה כמו רדיו ישן ומתנהג כמו רמקול חדש.', c: 0, p: 549, w: 980, v: 'colorTech', s: 'a retro-styled portable speaker with a metal grille, cream body and a leather carry handle' },
  { n: 'רדיו דיגיטלי למטבח', d: 'תצוגה ברורה, שעון מעורר ורמקול שמספיק למטבח שלם.', c: 0, p: 289, w: 720, v: 'colorTech', s: 'a small digital kitchen radio with a clear display' },
  { n: 'אוזניות לילדים עם הגבלת עוצמה', d: 'תקרת עוצמה מובנית של 85 דציבל וקשת מתכווננת.', c: 0, p: 179, w: 190, v: 'colorTech', s: "volume-limited children's headphones in a bright colour" },
  { n: 'מעמד לאוזניות', d: 'מעמד שולחני עם בסיס כבד שלא נופל, שומר על צורת הכרית.', c: 0, p: 129, w: 620, v: 'colorTech', s: 'a headphone stand with a weighted base' },
  { n: 'נגן מוזיקה כיס', d: 'נגן קטן עם גלגל ניווט ומסך זעיר, בלי התראות ובלי אפליקציות. רק מוזיקה.', c: 0, p: 429, w: 90, v: 'colorTech', s: 'a small square pocket music player with a tiny screen and a circular scroll wheel' },
