...
export const TECH_PRODUCTS = [
  ...
  { n: 'רמקול בלוטות׳ נייד', d: 'עמידות IPX7 מלאה למים, 20 שעות ניגון ורצועה לתלייה.', c: 0, sub: 'רמקולים ומערכות', sub2: 'רמקולים ניידים', p: 399, w: 640, v: 'colorTech', s: 'a portable cylindrical bluetooth speaker with a fabric grille and a wrist strap' },
  { n: 'רמקול בלוטות׳ קטן', d: 'נכנס לכיס ומחזיק יום שלם. מתאים למרפסת ולנסיעות.', c: 0, sub: 'רמקולים ומערכות', sub2: 'רמקולים ניידים', p: 199, w: 260, v: 'colorTech', s: 'a compact pocket bluetooth speaker' },
  { n: 'רמקול מדף לסלון', d: 'זוג רמקולים פסיביים עם דופן עץ, מתחברים למגבר קיים.', c: 0, sub: 'רמקולים ומערכות', sub2: 'מערכות לסלון', p: 1_290, w: 6_800, v: 'colorTech', s: 'a pair of bookshelf speakers with wooden cabinets and fabric fronts' },
  { n: 'סאונדבר לטלוויזיה', d: 'שיפור ניכר על רמקולי הטלוויזיה בחיבור אחד, עם סאב אלחוטי נפרד.', c: 0, sub: 'רמקולים ומערכות', sub2: 'מערכות לסלון', p: 1_190, w: 4_200, v: null, s: 'a slim soundbar with a separate wireless subwoofer' },
  { n: 'מגבר סטריאו קומפקטי', d: 'שני ערוצים בהספק אמיתי, כניסת בלוטות׳ וכניסת פטיפון מובנית.', c: 0, sub: 'רמקולים ומערכות', sub2: 'מערכות לסלון', p: 1_490, w: 5_400, v: null, s: 'a compact stereo amplifier with a large volume knob and a brushed front panel' },
  { n: 'פטיפון עם מגבר מובנה', d: 'מחט מתחלפת ומגבר פנימי, מתחבר ישירות לרמקולים פעילים.', c: 0, sub: 'רמקולים ומערכות', sub2: 'מערכות לסלון', p: 1_690, w: 5_600, v: null, s: 'a modern turntable with a built-in preamp on a wooden plinth' },
  ...
  { n: 'רמקול רטרו עם ידית', d: 'גוף מתכת וידית עור, בלוטות׳ מלא בפנים. נראה כמו רדיו ישן ומתנהג כמו רמקול חדש.', c: 0, sub: 'רמקולים ומערכות', sub2: 'רמקולים ניידים', p: 549, w: 980, v: 'colorTech', s: 'a retro-styled portable speaker with a metal grille, cream body and a leather carry handle' },
  { n: 'רדיו דיגיטלי למטבח', d: 'תצוגה ברורה, שעון מעורר ורמקול שמספיק למטבח שלם.', c: 0, sub: 'רמקולים ומערכות', sub2: 'רמקולים ניידים', p: 289, w: 720, v: 'colorTech', s: 'a small digital kitchen radio with a clear display' },
