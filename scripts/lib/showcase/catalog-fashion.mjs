...
export const FASHION_PRODUCTS = [
  ...
  { n: 'שמלת קיץ פרחונית', d: 'הדפס פרחים עדין על בד קליל, כתפיות דקות ואורך מעל הברך. קלילה במיוחד ליום חם.', c: 0, sub: 'שמלות', p: 249, w: 260, v: 'apparel', s: 'a floral summer dress with thin straps, light airy fabric, small blue flower print' },
  ...
  { n: 'שמלת ערב שחורה', d: 'גזרה נקייה ומחטבת עם גב פתוח, בד עבה שמחזיק צורה לאורך הערב.', c: 0, sub: 'שמלות', p: 429, w: 460, v: 'apparel', s: 'an elegant black evening dress with an open back, structured fabric' },
  { n: 'חולצת קרופ בסיסית', d: 'כותנה עבה, גזרה קצרה, צווארון עגול. נכנסת כמעט לכל קומבינציה בארון.', c: 0, sub: 'חולצות וגופיות', p: 89, w: 140, v: 'apparel', s: 'a cropped basic cotton t-shirt in off-white' },
  { n: 'חולצת ריב שרוול ארוך', d: 'בד ריב נצמד עם צווארון גולף נמוך, נמתח בנוחות ולא מאבד צורה בכביסה.', c: 0, sub: 'חולצות וגופיות', p: 119, w: 190, v: 'apparel', s: 'a fitted long-sleeve ribbed top in deep terracotta with a mock neck' },
  ...
  { n: 'גופיית ריב', d: 'גופייה בסיסית מבד ריב עם כתפיות רחבות. נוחה לבד ומושלמת כשכבה מתחת.', c: 0, sub: 'חולצות וגופיות', p: 69, w: 110, v: 'apparel', s: 'a ribbed tank top in cream with wide straps' },
  { n: 'חולצת מחשוף V רכה', d: 'בד ויסקוזה רך עם מחשוף V מעודן ושרוול קצר מתנפח קלות.', c: 0, sub: 'חולצות וגופיות', p: 139, w: 160, v: 'apparel', s: 'a soft V-neck blouse in muted lilac with slightly puffed short sleeves' },
  ...
  { n: 'סווטשירט קרופ', d: 'פוטר כותנה רך עם גזרה קצרה וגומי במותן. נעים במיוחד מהכביסה הראשונה.', c: 0, sub: 'סריגים', p: 179, w: 380, v: 'apparel', s: 'a cropped cotton sweatshirt in dusty sage' },
  ...
  { n: 'חצאית ג׳ינס מיני', d: 'דנים עבה בגזרה ישרה עם שסע קדמי קטן וכיסים אמיתיים.', c: 0, sub: 'מכנסיים וחצאיות', p: 189, w: 380, v: 'apparel', s: 'a denim mini skirt in light wash with a small front slit' },
  { n: 'חליפת בלייזר מחויטת', d: 'בלייזר בגזרה נקייה עם רפידות עדינות בכתף, מגיע עם מכנס תואם.', c: 0, sub: 'מעילים וז׳קטים', p: 549, w: 980, v: 'apparel', s: 'a tailored blazer in warm chocolate brown, structured shoulders' },
  ...
  { n: 'סט אימון שני חלקים', d: 'טופ קצר ולג׳ינס תואם מבד נמתח שמחזיק צורה, מתאים גם לאימון וגם ליום.', c: 0, sub: 'מעילים וז׳קטים', p: 289, w: 420, v: 'apparel', s: 'a matching two-piece activewear set in mauve, cropped top and leggings' },
  ...
  { n: 'נעלי עבודה מחוספסות', d: 'עור עבה עם סוליה משוננת ותפרים כפולים. בנויות לשרוד.', c: 2, sub: 'נעליים לשטח', p: 589, w: 1_280, v: 'shoes', s: 'rugged lace-up work boots in oiled brown leather with a lug sole' },
