...
export const FASHION_PRODUCTS = [
  ...
  { n: 'סוודר צמר מריחה', sub: 'סריגים', d: 'צמר מריחה דק שמחמם באמת ולא מגרד, עם צווארון עגול נמוך.', c: 1, p: 379, w: 460, v: 'apparel', s: 'a fine merino wool crewneck sweater in charcoal grey' },
  ...
  { n: 'ז׳קט בלייזר לא מובנה', sub: 'חליפות ואירועים', d: 'בלייזר בלי מבנה פנימי — קליל כמו חולצה ומסודר כמו ז׳קט. הפריט שהופך ג׳ינס לערב.', c: 1, p: 649, w: 780, v: 'apparel', s: 'an unstructured blazer in warm sand, worn open by a cropped male figure over a plain tee' },
