...
function order(overrides: Partial<Order> = {}): Order {
  return {
    ...
    items: [{ productId: 'p1', productName: 'חולצה', productSlug: 'shirt', storeSlug: 'urban', storeName: 'Urban Threads', price: 100, qty: 1 }],
    storeSubtotals: { urban: { storeName: 'Urban Threads', subtotal: 100, shipping: 0 } },
    shippingAmount: 0, totalAmount: 100,
