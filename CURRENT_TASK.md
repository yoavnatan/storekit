...
1. בפילטר של המוצרים יש שם מצב hover לא נכון, כאשר כפתור נבחר ועומדים עליו לא צריך להיות שינוי (כרגע הטקסט הופך לבלתי נראה)
2. בלשונית מוצרים, כל ההדר של המוצרים כולל הוספת מוצר, הדר של הטבלה, והאפשרויות שנפתחות כאשר בוחרים את אחד המוצרים

## Next

 
- בדשבורד המוכר בלשונית מוצרים: כל ההדר של המוצרים כולל הוספת מוצר, הדר של הטבלה, והאפשרויות שנפתחות כאשר בוחרים את אחד המוצרים- צריכים להיות סטיקי גם כשהטבלה נגללת. אולי נכון יותר לומר: ניתן לגלול את המוצרים עצמם וכל השאר נשאר קבוע. ואת כל הדשבורד קצת יותר להצמיד להדר. זו אפשרות אחת, אפשרות שניה עימוד.
...
לשונית מוצרים בדשבורד מוכר — להחליט: הדר+שורת פעולות סטיקיים בגלילה (רק טבלת המוצרים עצמה נגללת) מול עימוד. וגם: hover שגוי על כפתור מסונן/נבחר בפילטרים (הטקסט נעלם).
