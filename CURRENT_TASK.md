...
1. תפריט ההתראות ותפריט הווישטליסט צריך להיות באותו העיצוב פחות או יותר הכוונה שלמעלה יהיה איקס של יציאה. 

2. בווישליסט כשפותחים אותו ויש סקלטון טעינה, לרגע הכותרת היא wishlist גם כאשר האתר בעברית. צריך לתקן.

3. לגבי ההזמנות בדשבורד המוכרים: המוכר צריך להיות מסוגל לשנות פרטים בהזמנה.
זה צריך להיות בצורה שלא תגרום לו לשנות משהו בטעות, אולי שזה פותח מודל חדש של עריכת פרטי הזמנה כדי שיהיה ברור שהוא משנה עכשיו פרטים.

4. לגבי פרטים אישיים באיזור האישי של הלקוח: יש שם תיבה בתוך תיבה, זה צריך להיות הכל בתוך התיבה החיצונית (העריכה של הפרטים האישיים)
...
כל הסעיפים ב-`Your instruction` הושלמו בסשנים הקודמים. הצעד הבא המומלץ: שיפור תהליך הסרת הרקע של תמונות (מודל בחירה חזותי, תמיכה בחיתוך + הסרת רקע במקביל).
